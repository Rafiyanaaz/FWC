...
\title{
\vspace{1cm}
{\includegraphics[width=0.15\textwidth]{ iithlogo.jpg} \\ 7474 Decade Counter} }
...
\begin{figure}[h]                           
\centering                                 
\includegraphics[width=0.2\textwidth]{fig01.jpg}                                           
\caption{\label{fig-2:Gates}}               
\end{figure}
\begin{figure}[h]                           
\centering                            
\includegraphics[width=0.5\textwidth]{fig02.jpg }                      
\caption{\label{fig-1:Gates}}           
\end{figure}

\begin{figure}[h]                           
\centering                                 
\includegraphics[width=0.4\textwidth]{fig03.jpg  }                                           
...
\item Make the connections of arduino, 7447 and two 7474 ICs according to Fig-4.
	\begin{figure}[h] 
	\centering 
	\includegraphics[width=0.5\textwidth]{fig04.jpg     }
...
\begin{figure}[h]                           
\centering                                 
\includegraphics[width=0.3\textwidth]{fig5.jpg}                                           
